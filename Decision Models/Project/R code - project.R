...
plot(result, final = T);round(data.frame(sales=tree$variables$sales*tree$variables$size, ratio_47=tree$variables$ratio_less_47, ratio_between=tree$variables$ratio_between, ratio_50=tree$variables$ratio_more_50),3)
